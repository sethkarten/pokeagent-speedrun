...
class Move(IntEnum):
    """Move IDs in Emerald (complete list from pret/pokeemerald)"""
    NONE = 0
    POUND = 1
    KARATE_CHOP = 2
    DOUBLE_SLAP = 3
...
class MapLocation(IntEnum):
    ...
    # Indoor Ever Grande (Group 17) - but 0x1100 also maps to Briney's House due to memory reading issue
    ...
    RUSTURF_TUNNEL = 0x1904
    UNDERWATER_SOOTOPOLIS_CITY = 0x1905
    DESERT_RUINS = 0x1906
    GRANITE_CAVE_1F = 0x1907
    ...
    MT_PYRE_5F = 0x1B13
    MT_PYRE_6F = 0x1B14
    MT_PYRE_EXTERIOR = 0x1B15
    MT_PYRE_SUMMIT = 0x1B16
    AQUA_HIDEOUT_1F = 0x1B17
    AQUA_HIDEOUT_B1F = 0x1B18
    AQUA_HIDEOUT_B2F = 0x1B19
    UNDERWATER_SEAFLOOR_CAVERN = 0x1B1A
    SEAFLOOR_CAVERN_ENTRANCE = 0x1B1B
    SEAFLOOR_CAVERN_ROOM1 = 0x1B1C
    SEAFLOOR_CAVERN_ROOM2 = 0x1B1D
    SEAFLOOR_CAVERN_ROOM3 = 0x1B1E
    SEAFLOOR_CAVERN_ROOM4 = 0x1B1F
    SEAFLOOR_CAVERN_ROOM5 = 0x1B20
    SEAFLOOR_CAVERN_ROOM6 = 0x1B21
    SEAFLOOR_CAVERN_ROOM7 = 0x1B22
    SEAFLOOR_CAVERN_ROOM8 = 0x1B23
    SEAFLOOR_CAVERN_ROOM9 = 0x1B24
    CAVE_OF_ORIGIN_ENTRANCE = 0x1B25
    CAVE_OF_ORIGIN_1F = 0x1B26
    CAVE_OF_ORIGIN_UNUSED_RUBY_SAPPHIRE_MAP1 = 0x1B27
    CAVE_OF_ORIGIN_UNUSED_RUBY_SAPPHIRE_MAP2 = 0x1B28
    CAVE_OF_ORIGIN_UNUSED_RUBY_SAPPHIRE_MAP3 = 0x1B29
    CAVE_OF_ORIGIN_B1F = 0x1B2A
    VICTORY_ROAD_1F = 0x1B2B
    VICTORY_ROAD_B1F = 0x1B2C
    VICTORY_ROAD_B2F = 0x1B2D
    SHOAL_CAVE_LOW_TIDE_ENTRANCE_ROOM = 0x1B2E
    SHOAL_CAVE_LOW_TIDE_INNER_ROOM = 0x1B2F
    SHOAL_CAVE_LOW_TIDE_STAIRS_ROOM = 0x1B30
    SHOAL_CAVE_LOW_TIDE_LOWER_ROOM = 0x1B31
    SHOAL_CAVE_HIGH_TIDE_ENTRANCE_ROOM = 0x1B32
    SHOAL_CAVE_HIGH_TIDE_INNER_ROOM = 0x1B33
    NEW_MAUVILLE_ENTRANCE = 0x1B34
    NEW_MAUVILLE_INSIDE = 0x1B35
    ABANDONED_SHIP_DECK = 0x1B36
    ABANDONED_SHIP_CORRIDORS_1F = 0x1B37
    ABANDONED_SHIP_ROOMS_1F = 0x1B38
    ABANDONED_SHIP_CORRIDORS_B1F = 0x1B39
    ABANDONED_SHIP_ROOMS_B1F = 0x1B3A
    ABANDONED_SHIP_ROOMS2_B1F = 0x193B
    ABANDONED_SHIP_UNDERWATER1 = 0x193C
    ABANDONED_SHIP_ROOM_B1F = 0x193D
    ABANDONED_SHIP_ROOMS2_1F = 0x193E
    ABANDONED_SHIP_CAPTAINS_OFFICE = 0x193F
    ABANDONED_SHIP_UNDERWATER2 = 0x1940
    ABANDONED_SHIP_HIDDEN_FLOOR_CORRIDORS = 0x1941
    ABANDONED_SHIP_HIDDEN_FLOOR_ROOMS = 0x1942
    ISLAND_CAVE = 0x1943
    ANCIENT_TOMB = 0x1944
    UNDERWATER_ROUTE134 = 0x1945
    UNDERWATER_SEALED_CHAMBER = 0x1946
    SEALED_CHAMBER_OUTER_ROOM = 0x1947
    SEALED_CHAMBER_INNER_ROOM = 0x1948
    SCORCHED_SLAB = 0x1949
    AQUA_HIDEOUT_UNUSED_RUBY_MAP1 = 0x194A
    AQUA_HIDEOUT_UNUSED_RUBY_MAP2 = 0x194B
    AQUA_HIDEOUT_UNUSED_RUBY_MAP3 = 0x194C
    SKY_PILLAR_ENTRANCE = 0x194D
    SKY_PILLAR_OUTSIDE = 0x194E
    SKY_PILLAR_1F = 0x194F
    SKY_PILLAR_2F = 0x1950
    SKY_PILLAR_3F = 0x1951
    SKY_PILLAR_4F = 0x1952
    SHOAL_CAVE_LOW_TIDE_ICE_ROOM = 0x1953
    SKY_PILLAR_5F = 0x1954
    SKY_PILLAR_TOP = 0x1955
    MAGMA_HIDEOUT_1F = 0x1956
    MAGMA_HIDEOUT_2F_1R = 0x1957
    MAGMA_HIDEOUT_2F_2R = 0x1958
    MAGMA_HIDEOUT_3F_1R = 0x1959
    MAGMA_HIDEOUT_3F_2R = 0x195A
    MAGMA_HIDEOUT_4F = 0x195B
    MAGMA_HIDEOUT_3F_3R = 0x195C
    MAGMA_HIDEOUT_2F_3R = 0x195D
    MIRAGE_TOWER_1F = 0x195E
    MIRAGE_TOWER_2F = 0x195F
    MIRAGE_TOWER_3F = 0x1960
    MIRAGE_TOWER_4F = 0x1961
    DESERT_UNDERPASS = 0x1962
    ARTISAN_CAVE_B1F = 0x1963
    ARTISAN_CAVE_1F = 0x1964
    UNDERWATER_MARINE_CAVE = 0x1965
    MARINE_CAVE_ENTRANCE = 0x1966
    MARINE_CAVE_END = 0x1967
    TERRA_CAVE_ENTRANCE = 0x1968
    TERRA_CAVE_END = 0x1969
    ...
    SAFARI_ZONE_NORTH = 0x1B01
    SAFARI_ZONE_SOUTHWEST = 0x1B02
    SAFARI_ZONE_SOUTH = 0x1B03
    BATTLE_FRONTIER_OUTSIDE_WEST = 0x1B04
    BATTLE_FRONTIER_BATTLE_TOWER_LOBBY = 0x1B05
    BATTLE_FRONTIER_BATTLE_TOWER_ELEVATOR = 0x1B06
    BATTLE_FRONTIER_BATTLE_TOWER_CORRIDOR = 0x1B07
    BATTLE_FRONTIER_BATTLE_TOWER_BATTLE_ROOM = 0x1B08
    SOUTHERN_ISLAND_EXTERIOR = 0x1B09
    SOUTHERN_ISLAND_INTERIOR = 0x1B0A
    SAFARI_ZONE_REST_HOUSE = 0x1B0B
    SAFARI_ZONE_NORTHEAST = 0x1B0C
    SAFARI_ZONE_SOUTHEAST = 0x1B0D
    BATTLE_FRONTIER_OUTSIDE_EAST = 0x1B0E
    BATTLE_FRONTIER_BATTLE_TOWER_MULTI_PARTNER_ROOM = 0x1B0F
    BATTLE_FRONTIER_BATTLE_TOWER_MULTI_CORRIDOR = 0x1B10
    BATTLE_FRONTIER_BATTLE_TOWER_MULTI_BATTLE_ROOM = 0x1B11
    BATTLE_FRONTIER_BATTLE_DOME_LOBBY = 0x1B12
    BATTLE_FRONTIER_BATTLE_DOME_CORRIDOR = 0x1B13
    BATTLE_FRONTIER_BATTLE_DOME_PRE_BATTLE_ROOM = 0x1B14
    BATTLE_FRONTIER_BATTLE_DOME_BATTLE_ROOM = 0x1B15
    BATTLE_FRONTIER_BATTLE_PALACE_LOBBY = 0x1B16
    BATTLE_FRONTIER_BATTLE_PALACE_CORRIDOR = 0x1B17
    BATTLE_FRONTIER_BATTLE_PALACE_BATTLE_ROOM = 0x1B18
    BATTLE_FRONTIER_BATTLE_PYRAMID_LOBBY = 0x1B19
    BATTLE_FRONTIER_BATTLE_PYRAMID_FLOOR = 0x1B1A
    BATTLE_FRONTIER_BATTLE_PYRAMID_TOP = 0x1B1B
    BATTLE_FRONTIER_BATTLE_ARENA_LOBBY = 0x1B1C
    BATTLE_FRONTIER_BATTLE_ARENA_CORRIDOR = 0x1B1D
    BATTLE_FRONTIER_BATTLE_ARENA_BATTLE_ROOM = 0x1B1E
    BATTLE_FRONTIER_BATTLE_FACTORY_LOBBY = 0x1B1F
    BATTLE_FRONTIER_BATTLE_FACTORY_PRE_BATTLE_ROOM = 0x1B20
    BATTLE_FRONTIER_BATTLE_FACTORY_BATTLE_ROOM = 0x1B21
    BATTLE_FRONTIER_BATTLE_PIKE_LOBBY = 0x1B22
    BATTLE_FRONTIER_BATTLE_PIKE_CORRIDOR = 0x1B23
    BATTLE_FRONTIER_BATTLE_PIKE_THREE_PATH_ROOM = 0x1B24
    BATTLE_FRONTIER_BATTLE_PIKE_ROOM_NORMAL = 0x1B25
    BATTLE_FRONTIER_BATTLE_PIKE_ROOM_FINAL = 0x1B26
    BATTLE_FRONTIER_BATTLE_PIKE_ROOM_WILD_MONS = 0x1B27
    BATTLE_FRONTIER_RANKING_HALL = 0x1B28
    BATTLE_FRONTIER_LOUNGE1 = 0x1B29
    BATTLE_FRONTIER_EXCHANGE_SERVICE_CORNER = 0x1B2A
    BATTLE_FRONTIER_LOUNGE2 = 0x1B2B
    BATTLE_FRONTIER_LOUNGE3 = 0x1B2C
    BATTLE_FRONTIER_LOUNGE4 = 0x1B2D
    BATTLE_FRONTIER_SCOTTS_HOUSE = 0x1B2E
    BATTLE_FRONTIER_LOUNGE5 = 0x1B2F
    BATTLE_FRONTIER_LOUNGE6 = 0x1B30
    BATTLE_FRONTIER_LOUNGE7 = 0x1B31
    BATTLE_FRONTIER_RECEPTION_GATE = 0x1B32
    BATTLE_FRONTIER_LOUNGE8 = 0x1B33
    BATTLE_FRONTIER_LOUNGE9 = 0x1B34
    BATTLE_FRONTIER_POKEMON_CENTER_1F = 0x1B35
    BATTLE_FRONTIER_POKEMON_CENTER_2F = 0x1B36
    BATTLE_FRONTIER_MART = 0x1B37
    FARAWAY_ISLAND_ENTRANCE = 0x1B38
    FARAWAY_ISLAND_INTERIOR = 0x1B39
    BIRTH_ISLAND_EXTERIOR = 0x1B3A
