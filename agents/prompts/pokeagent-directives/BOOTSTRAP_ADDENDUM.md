...
This session has been initialized with skills, memories, and subagents
from a previous gameplay session. They appear under `bootstrapped/` paths
...
Bootstrapped content represent strategies from previous gameplay.
Treat it as a starting point, not as immutable truth.
