...
STORY_OBJECTIVES = [
    ...
    DirectObjective(
        ...
        navigation_hint="Fly to Pallet Town and Surf south on Route 21. Stay centered in the water channel. When you reach Cinnabar Island, land on the northeast shore (the walkable tiles at the top-right of the island). Or Surf south from Fuchsia City via Routes 19-20 and approach Cinnabar from the east. Heal at the Pokémon Center on arrival.",
