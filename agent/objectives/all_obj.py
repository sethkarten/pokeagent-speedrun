"""
Full Game Objectives List

Complete list of 244 objectives covering the entire Pokemon Emerald playthrough
from tutorial through Elite Four and postgame content.

This list is imported by direct_objectives.py's load_full_game_sequence() method.
...
ALL_OBJECTIVES = [
    # =========================================================================
    # PHASE 1: TUTORIAL & LITTLEROOT TOWN
    # =========================================================================
    DirectObjective(
        id="tutorial_001",
    ...
    # =========================================================================
    # PHASE 2: ROUTE 103 RIVAL BATTLE & POKEDEX
    # =========================================================================
    DirectObjective(
        id="early_012",
    ...
    # =========================================================================
    # PHASE 3: ROUTE 102 & PETALBURG CITY
    # =========================================================================
    DirectObjective(
        id="petalburg_021",
    ...
    # =========================================================================
    # PHASE 4: RUSTBORO CITY & GYM 1 (ROXANNE - ROCK)
    # =========================================================================
    DirectObjective(
        id="rustboro_035",
    ...
    # =========================================================================
    # PHASE 5: DEWFORD TOWN & GYM 2 (BRAWLY - FIGHTING)
    # =========================================================================
    DirectObjective(
        id="dewford_050",
    ...
    # =========================================================================
    # PHASE 6: SLATEPORT CITY & TEAM AQUA
    # =========================================================================
    DirectObjective(
        id="slateport_067",
    ...
    # =========================================================================
    # PHASE 7: MAUVILLE CITY & GYM 3 (WATTSON - ELECTRIC)
    # =========================================================================
    DirectObjective(
        id="mauville_078",
    ...
    DirectObjective(
        id="mauville_082",
        description="Catch Geodude for Ground type (Electric immunity)",
        action_type="catch",
    ...
    # =========================================================================
    # PHASE 8: MT. CHIMNEY & LAVARIDGE (GYM 4 - FLANNERY - FIRE)
    # =========================================================================
    DirectObjective(
        id="chimney_091",
    ...
    # =========================================================================
    # PHASE 9: PETALBURG GYM 5 (NORMAN - NORMAL)
    # =========================================================================
    DirectObjective(
        id="norman_115",
    ...
    # =========================================================================
    # PHASE 10: ROUTE 118-119, WEATHER INSTITUTE, FORTREE (GYM 6 - WINONA - FLYING)
    # =========================================================================
    DirectObjective(
        id="fortree_126",
    ...
    # =========================================================================
    # PHASE 11: MT. PYRE & TEAM AQUA HIDEOUT
    # =========================================================================
    DirectObjective(
        id="pyre_150",
    ...
    # =========================================================================
    # PHASE 12: MOSSDEEP CITY & GYM 7 (TATE & LIZA - PSYCHIC)
    # =========================================================================
    DirectObjective(
        id="mossdeep_168",
    ...
    # =========================================================================
    # PHASE 13: SEAFLOOR CAVERN & AWAKENING KYOGRE
    # =========================================================================
    DirectObjective(
        id="seafloor_183",
    ...
    # =========================================================================
    # PHASE 15: SOOTOPOLIS GYM 8 (JUAN - WATER)
    # =========================================================================
    DirectObjective(
        id="sootopolis_211",
    ...
    # =========================================================================
    # PHASE 16: VICTORY ROAD & POKEMON LEAGUE
    # =========================================================================
    DirectObjective(
        id="league_219",
