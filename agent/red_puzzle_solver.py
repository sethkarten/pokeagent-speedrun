#!/usr/bin/env python3
"""
Red Puzzle Solver Agent

Analyzes puzzle states in Pokemon Red and provides guidance on how to solve them.
Covers spinner mazes, warp puzzles, and other tricky locations beyond just gyms.
"""
